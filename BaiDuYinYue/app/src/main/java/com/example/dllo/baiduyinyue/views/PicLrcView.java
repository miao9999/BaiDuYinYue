 ...
 * 显示一行歌词
 */
public class PicLrcView extends View {
    ...
    public PicLrcView(Context context) {
        this(context, null);
    }

    public PicLrcView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PicLrcView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs) {
        ...
        mAnimationDuration = ta.getInt(R.styleable.LrcView_animation_duration, 10);
        mAnimationDuration = mAnimationDuration < 0 ? 10 : mAnimationDuration;
